...
public class SubscriptionService {
    ...
    public void sendPostQuery(String bodyRequest) {
        response = SerenityRest.given()
                ...
                .header(CONTENT_TYPE, SUBSCRIPTION_CONTENT_TYPE)
                .body(bodyRequest)
                .post(new BaseApi().getEndpointByKey("https://628e7107a339dfef87ae307a.mockapi.io/APIAutomation"));
    ...
    public Response updateUserById(Object body, int id) {
        response = SerenityRest.given()
                ...
                .header(CONTENT_TYPE, SUBSCRIPTION_CONTENT_TYPE)
                .body(body)
                .put(new BaseApi().getEndpointByKey("https://628e7107a339dfef87ae307a.mockapi.io/APIAutomation") + "/" + id);
